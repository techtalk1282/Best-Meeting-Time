 ...
 * Version: v1.1 (ADD REFUND POLICY LINK)
 * Purpose:
 * - Create one consistent legal/trust footer across the site
 * - Include Privacy Policy, Terms, Disclaimer, Cookie Policy, Refund Policy, and Contact
 * - Keep legal links in the footer, not the main navigation
 *
 * Changes:
 * - Added Refund Policy footer link
 *
 * Rollback:
 * - Restore v1.0 FooterSection.tsx if needed
 */
